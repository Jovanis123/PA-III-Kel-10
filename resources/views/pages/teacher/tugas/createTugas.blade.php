        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Create Tugas</h3>
                </div>
                <!-- /.card-header -->
                ...
                <form role="form" action="{{ route('teacher.save.tugas') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="judul_tugas" type="text" class="form-control" id="input2" placeholder="Judul Tugas">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input name="file_tugas" type="file" class="form-control" id="input2" placeholder="File Tugas">
