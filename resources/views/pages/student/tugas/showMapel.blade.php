...
@section('title', 'Pilih Mata Pelajaran - Tugas')
        ...
        <div class="row">
          ...
          @foreach($mapel as $m)
            <div class="col-lg-3 col-6">
                ...
                <a href="{{ route('student.tugas.mapel.list', $m->id)  }}" class="small-box-footer">Lihat List Tugas <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
          @endforeach
